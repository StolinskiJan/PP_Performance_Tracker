...
namespace PTr.Controllers
{
    ...
    public class TasksController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Task.Include(t => t.TaskType).Include(t => t.User).Include(t => t.WorkSession);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["WorkSessionId"] = new SelectList(_context.WorkSession, "Id", "LogIn");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Hours,Days,Money,TaskTypeId,WorkSessionId,UserId")] Models.Task task)
        {
            ...
            ViewData["WorkSessionId"] = new SelectList(_context.WorkSession, "Id", "Id", task.WorkSessionId);
            return View(task);
        }
